...
public class TasksNEW extends AppCompatActivity {
    ...
    private void addDrawerItems(){
        ...
        drawerNavList2.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch (position) {
                    case 0: //Log History
                        Intent intent = new Intent(TasksNEW.this, MainActivity.class);
                        startActivity(intent);
                        break;
                    case 1:
                        Intent intent1 = new Intent(TasksNEW.this, Browse.class);
                        startActivity(intent1);
                        break;
                    case 2:
                        Intent intent2 = new Intent(TasksNEW.this, MyPlantsNEW.class);
                        startActivity(intent2);
                        break;
                    case 3:
                        Intent intent3 = new Intent(TasksNEW.this, Calendar.class);
                        startActivity(intent3);
                        break;
                    case 4:
                        Intent intent4 = new Intent(TasksNEW.this, TasksNEW.class);
                        startActivity(intent4);
                        break;
                    case 5:
                        Intent intent5 = new Intent(TasksNEW.this, SettingsNEW.class);
